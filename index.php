...
if (isset($_POST['submit'])) {
    ...
    $usuarioEncontrado = $loginModel->login($usuario, $contrasena);
    ...
    if ($usuarioEncontrado) {
        ...
        $_SESSION['foto_U'] = json_decode($usuarioEncontrado['foto_U']);
                            ...
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="auth-content my-auto">
                                    ...
                                    <form class="custom-form mt-4 pt-2" method="POST" action="">
                                        ...
                                        <div class="mb-3">
                                            <button class="btn btn-primary w-100 waves-effect waves-light" type="submit" name="submit" value="Iniciar">Iniciar</button>
                                        </div>
                                    </form>
