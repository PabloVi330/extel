...
function call_ajax_page(page) {
	...
	if(page === "index.php")
	{
		document.title = "Dashboard | Veltrix - Admin & Dashboard Template";
	}
	else
	{
		var title = page.replace(".php", "");
		var title1 = title.replace("-", " ");
		document.title = title1.charAt(0).toUpperCase() + title1.slice(1) + " | Veltrix - Admin & Dashboard Template";
	}
