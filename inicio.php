...
<body>
    ...
    <div id="layout-wrapper">
        ...
        <?php
        include_once 'seccitions/cabecera.php'
        ?>
        <?php
        include_once 'seccitions/menu.php'
        ?>
    ...
    <!-- <script>
        ...
        conn.onopen = function(event) {
            console.log('Conectado al servidor WebSocket' + event.target);
        };
        ...
        conn.onmessage = function(event) {
            ...
            if (message.type === "notification") {
                // Muestra la notificación en la interfaz de usuario
