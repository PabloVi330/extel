        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-none d-sm-inline-block">
                <button type="button" class="btn header-item" data-bs-toggle="dropdown" aria-haspopup="true"
                    aria-expanded="false">
                    <img id="header-lang-img" src="assets/images/flags/us.jpg" alt="Header
                                    Language" height="16">
                </button>
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item
                                noti-icon position-relative" id="page-header-notifications-dropdown"
                ...
                <div class="dropdown-menu dropdown-menu-lg
                    ...
                    <div data-simplebar style="max-height: 230px;" id="content-notificaciones">
                    ...
                    <script>
                        var conn = new WebSocket('ws://localhost:8080'); // Reemplaza con la dirección de tu servidor WebSocket

                        conn.onopen = function (event) {
                            console.log('Conectado al servidor WebSocket desde Cabecera' + event.target);
                        };
                        ...
                        conn.onmessage = function (event) {
                           ...
                           $('#content-notificaciones').append(itemHTML);
                        };
                    </script>
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item
                    ...
                    <img class="rounded-circle header-profile-user"
                        src="controllers/uploads/users/<?php echo $_SESSION['foto_U'][0] ?>" alt="Header Avatar">
